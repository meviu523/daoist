...
(function (root) {
  ...
  G.EVENTS = [
    ...
    { id: 'elevator', kind: 'delivery', title: '停在七楼的电梯', text: '老楼电梯突然卡住，里面有人拍门求助。你的客人住在十二层，订单时限还在倒数。', choices: [c('先联系物业并陪到有人回应','隔着门说了几分钟话，维修人员终于赶到。',{karma:3,rep:1},{duration:8}),c('记下楼层，走楼梯继续配送','你把求助信息发给物业，随后提着餐盒继续向上。',{stamina:-5,rep:2}),c('请楼下住户代为守着','有人接过这段短暂的责任，你也没有耽误太久。',{karma:1,rep:1},{duration:3})] },
